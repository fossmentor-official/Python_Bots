...
intents.typing = False  # Disable typing notifications if not needed
intents.presences = False  # Disable presence tracking if not needed
intents.messages = True  # Ensure message content can be processed
